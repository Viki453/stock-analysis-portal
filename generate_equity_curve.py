...
import matplotlib
import matplotlib.pyplot as plt  # <--- FIX 1: ADDED THIS IMPORT
import warnings
...
# --- FIX 2: This is the more robust way to set the figure size for backtrader ---
# Set the default figure size *before* calling plot
...
# Good practice: reset the figure size to default
